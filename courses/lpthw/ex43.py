...
class CentralCorridor(Scene):
    ...
    def enter(self):
        ...
        print "mission is to get the bridge, and blow the ship up after getting into an"
        print "escape pood."
        print "\n"
        print "You're running down the central corridor to the Weapons Armory when"
        print "a Gothan jumps out, red scaly skin, dark grim teeth, and evil clown costume"
        print "flowing around his hate filled body. He's blocking the door to the"
        print "Armory and about to pull a weapon to blast you1"
        ...
        if action == "shoot!":
            ...
            print "You wake up shortly after only to die as the Gothan stomps on"
            ...
            print "putting him down, then jump through Weapon Armory door."
...
class EscapePod(Scene):
    ...
    def enter(self):
        ...
        print "interface. You get to the chamber with the scape pods, and"
